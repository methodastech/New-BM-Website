...
function decreament(incDec,prc,itm){
		...
		if(count.value<=0){
		  count.value=0;
			...
			/* total */
			/*
			var total_product = parseInt(total_amount)-parseInt(price.innerHTML);
			var pro_amount= document.getElementById("total_amount").innerHTML=total_product;
			
			var gtotal_amount = (parseInt(total_amount)-parseInt(price.innerHTML));
			var gtotal_amount= document.getElementById("gtotal_amount").innerHTML=gtotal_amount;
		}
}
...
function increament(incDec,prc,itm){
		...
		if(count.value>=10){
			...
			/* total*/
			/*
			var total_product = parseInt(price.innerHTML)+parseInt(total_amount);
			var total_amount= document.getElementById("total_amount").innerHTML=total_product;
			 
			var gtotal_amount = parseInt(total_amount)+parseInt(delivery_amount.innerHTML);
			var gtotal_amount= document.getElementById("gtotal_amount").innerHTML=gtotal_amount;		
		}
}

/* new code 08082023 end Hailey*/
...
$(document).on("click", ".alert", function(e) {
    bootbox.alert({
	message: "<img src='img/addtocart.png'><br><p>Item has been successfully added to your cart.</p>",
...
/*Add Wishlist color*/
function addWishlistFunction() {
   document.getElementById("addWishlist").classList.toggle("active");
}
