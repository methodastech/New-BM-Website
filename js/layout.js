...
<div class="brand-stamp">
  <div class="brand-stamp-logo" aria-label="Brand Method" role="img">
    <div class="brand-stamp-text" aria-hidden="true">
      <div class="brand-stamp-line brand-stamp-line--top">
        <span>BRAND</span>
        <svg class="brand-stamp-star" viewBox="0 0 100 100" aria-hidden="true" focusable="false">
          <polygon points="50,0 55.9,33.6 80.9,9.5 66.4,40.5 100,34.5 69,50 100,65.5 66.4,59.5 80.9,90.5 55.9,66.4 50,100 44.1,66.4 19.1,90.5 33.6,59.5 0,65.5 31,50 0,34.5 33.6,40.5 19.1,9.5 44.1,33.6"/>
        </svg>
      </div>
      <div class="brand-stamp-line"><span>METHOD</span></div>
    </div>
  </div>
</div>
